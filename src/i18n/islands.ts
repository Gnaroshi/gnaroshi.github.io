...
export const enIslandMessages = {
  paper: {
    ...
    activityByDate: "Paper reading activity by date", papersOnDate: "{date}: {count} reading sessions", aiReview: "AI review", needsReview: "Needs review",
...
export const koIslandMessages = {
  paper: {
    ...
    activityByDate: "날짜별 논문 읽기 활동", papersOnDate: "{date}: 읽기 세션 {count}회", aiReview: "AI 리뷰", needsReview: "리뷰 필요",
