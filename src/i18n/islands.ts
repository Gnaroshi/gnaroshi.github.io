...
export const enIslandMessages = {
  paper: {
    notebook: "Reading notes", searchAndFilter: "Search and filter", resetFilters: "Reset filters", search: "Search",
    ...
    filteringBy: "Filtering by", clearDate: "Clear date", cards: "Reading note cards", shown: "{shown} of {total} shown",
    noLogs: "No reading notes have been published yet.", noLogsBody: "A first note can be short: record why the paper matters and one question to revisit.",
    noMatches: "No reading notes match these filters.", noMatchesBody: "Adjust the filters or reset them to return to all reading notes.",
    activity: "Activity", last365: "Last 365 days", intensity: "Heatmap intensity legend", less: "Less", more: "More",
    activityByDate: "Reading activity by date", papersOnDate: "{date}: {count} reading sessions", aiReview: "Note review", needsReview: "Area to revisit",
    reviewDue: "Review due", draft: "Draft", featured: "Featured", futureMe: "Future me", read: "read", metadata: "Reading note metadata",
    priority: "Priority", minutes: "{count} min", tags: "Reading note tags", detail: "Reading note", paper: "Original paper", code: "Code", project: "Project",
    statistics: "Reading activity statistics", sessionsToday: "Sessions today", papersTouchedToday: "Papers touched today", minutesToday: "Minutes today",
    currentStreak: "Current active-day streak", distinctPapersThisMonth: "Distinct papers this month", deepSessions: "Deep sessions", implementations: "Implementations",
    publicNotes: "Reading notes: {count}. More activity views appear after three notes.", readingProcessEvidence: "Review summary",
    scoreScope: "Review results describe evidence in the published note; they do not measure intelligence or personal worth.", average: "Average", averageAi: "Average review result",
    averageSelf: "Average self-review", averageGap: "Average review difference", reviewsDue: "Reviews due", scoreTrend: "Review results over time",
    weakDimension: "Area to revisit", dimensionAverage: "{label}: {score}/10 average.", paperNotes: "Reading notes",
    trendLabel: "Note-review results over time", trendPoint: "{title}: {score} on {date}", noTrend: "No public review history yet.",
  ...
  question: {
    ...
    difficulty: "difficulty", answer: "Answer from memory", selfScore: "Self score", evidence: "What to include", confidence: "Confidence",
    save: "Save locally", copy: "Copy manual AI quiz prompt", openPaper: "Open paper", saved: "Saved locally in this browser.",
    copied: "Copied manual AI quiz prompt.", blocked: "Automatic copy was blocked. Select the prompt and copy it manually.", noEvidence: "Nothing has been recorded for the answer yet.",
    empty: "No questions yet.", emptyBody: "Questions will appear when published reading notes include material for recall practice."
  },
  graph: {
  ...
  exam: {
    ...
    mockLoaded: "Development practice questions loaded.", textLoaded: "Text practice loaded.", promptCopied: "Manual recall-practice prompt copied.", copyBlocked: "Automatic copy was blocked. The full prompt is selected; press Ctrl+C or Cmd+C.",
    principlesLabel: "Live recall-practice principles", principles: ["The result describes what the session shows from memory.", "You can stop anytime and export your transcript.", "The practice guide asks one question at a time.", "Use Korean or English."],
    setup: "Practice setup", setupHeading: "Choose how deeply to revisit the note", targetDepth: "Target depth", language: "Language", questions: "Questions",
    pass1: "Pass 1 — relevance", pass2: "Pass 2 — structure", pass3: "Pass 3 — deep understanding", korean: "Korean", english: "English",
    startLive: "Start live recall practice", stopLive: "Stop live practice", generateText: "Create text practice", microphoneReady: "Live voice is available. Microphone access is requested only when practice starts.",
    ...
    microphoneDenied: "Microphone permission was not granted.", startError: "Recall practice could not be started.", voiceLabel: "AI-generated practice voice",
    privacy: "The practice voice is AI-generated, not a human voice. Audio and transcript are not persisted by this page.",
    textFallback: "Text fallback", answerMemory: "Answer from memory", developmentMock: "Development mock", scoreText: "Review text answers", scoreStopped: "Review stopped live practice",
    transcript: "Transcript", liveConversation: "Live conversation", recordedLocal: "Recorded locally", turns: "{count} turns", examiner: "Practice guide", you: "You", transcriptEmpty: "Transcript events will appear here during live practice.",
    result: "Practice result", retrievalEvidence: "Recall result: {score}/100", confidence: "{value} confidence", mockWarning: "Development mock. This result did not evaluate correctness.",
    copyScore: "Copy result JSON", copyTranscript: "Copy transcript", exportScore: "Export result JSON", exportTranscript: "Export transcript", copied: "{label} copied.", copyFailed: "Could not copy {label}. Select it manually below.", prepared: "{filename} prepared locally.",
    keepLocal: "Keep the result local, or add it to the research record before the next update.", reviewJson: "Review result JSON",
    noApi: "No-API workflow", manualTitle: "Run recall practice manually", manualBody: "Copy the prompt into ChatGPT or another model. Keep the transcript local, then add the returned result JSON to the research record.",
    copyManual: "Copy manual recall-practice prompt", manualPrompt: "Manual recall-practice prompt"
  },
  manualReview: {
    rereview: "Review the note again", hide: "Hide manual prompt", title: "Or copy a note-review prompt",
    body: "Paste this into ChatGPT or another model, then save the returned JSON result.", copy: "Copy note-review prompt", cli: "CLI option",
    prompt: "Manual note-review prompt", copied: "Prompt copied.", selected: "Automatic copy was blocked. The full prompt is selected; press Ctrl+C or Cmd+C.",
...
export const koIslandMessages = {
  paper: {
    notebook: "읽기 기록", searchAndFilter: "검색과 필터", resetFilters: "필터 초기화", search: "검색",
    ...
    filteringBy: "선택한 날짜", clearDate: "날짜 해제", cards: "읽기 기록", shown: "전체 {total}개 중 {shown}개",
    noLogs: "아직 공개한 읽기 기록이 없습니다.", noLogsBody: "첫 기록은 짧아도 됩니다. 이 논문을 읽는 이유와 다시 볼 질문 하나를 남깁니다.",
    noMatches: "조건에 맞는 읽기 기록이 없습니다.", noMatchesBody: "필터를 조정하거나 초기화해 전체 읽기 기록으로 돌아갑니다.",
    activity: "활동", last365: "최근 365일", intensity: "읽기 활동 강도", less: "적음", more: "많음",
    activityByDate: "날짜별 읽기 활동", papersOnDate: "{date}: 읽기 세션 {count}회", aiReview: "노트 검토", needsReview: "다시 볼 부분",
    reviewDue: "복습 예정", draft: "초안", featured: "선택", futureMe: "미래의 나", read: "읽음", metadata: "읽기 기록 정보",
    priority: "우선순위", minutes: "{count}분", tags: "읽기 기록 태그", detail: "읽기 기록", paper: "논문 원문", code: "코드", project: "프로젝트",
    statistics: "논문 읽기 통계", sessionsToday: "오늘 읽기 세션", papersTouchedToday: "오늘 읽은 논문", minutesToday: "오늘 읽은 시간",
    currentStreak: "현재 연속 활동일", distinctPapersThisMonth: "이번 달 읽은 논문", deepSessions: "깊이 읽기 세션", implementations: "구현 시도",
    publicNotes: "읽기 기록 {count}개. 기록이 3개 이상 쌓이면 활동 보기가 열립니다.", readingProcessEvidence: "검토 결과",
    scoreScope: "검토 결과는 공개한 기록에 남은 근거를 설명하며 지능이나 개인의 가치를 평가하지 않습니다.", average: "평균", averageAi: "검토 결과 평균",
    averageSelf: "자기 검토 평균", averageGap: "검토 결과 차이", reviewsDue: "복습 예정", scoreTrend: "기록의 변화",
    weakDimension: "다시 볼 부분", dimensionAverage: "{label}: 평균 {score}/10", paperNotes: "읽기 기록",
    trendLabel: "시간에 따른 노트 검토 결과", trendPoint: "{title}: {date}에 {score}점", noTrend: "공개한 검토 이력이 아직 없습니다.",
  ...
  question: {
    ...
    difficulty: "난이도", answer: "기억에서 답하기", selfScore: "자기 평가", evidence: "답에 포함할 내용", confidence: "확신",
    save: "브라우저에 저장", copy: "수동 AI 퀴즈 프롬프트 복사", openPaper: "논문 열기", saved: "이 브라우저에 저장했습니다.",
    copied: "수동 AI 퀴즈 프롬프트를 복사했습니다.", blocked: "자동 복사가 차단되었습니다. 프롬프트를 선택해 직접 복사하세요.", noEvidence: "아직 답에 포함할 내용을 기록하지 않았습니다.",
    empty: "질문이 아직 없습니다.", emptyBody: "공개한 읽기 기록에 회상 연습 자료가 생기면 질문이 이곳에 나타납니다."
  },
  graph: {
  ...
  exam: {
    ...
    mockLoaded: "개발용 연습 질문을 불러왔습니다.", textLoaded: "텍스트 연습을 불러왔습니다.", promptCopied: "수동 회상 연습 프롬프트를 복사했습니다.", copyBlocked: "자동 복사가 차단되었습니다. 전체 프롬프트를 선택했으니 Ctrl+C 또는 Cmd+C를 누르세요.",
    principlesLabel: "실시간 회상 연습 원칙", principles: ["결과는 기억에서 설명한 내용이 보여 주는 범위를 정리합니다.", "언제든 멈추고 대화 기록을 내보낼 수 있습니다.", "연습 안내자는 한 번에 질문 하나를 합니다.", "한국어나 영어를 사용할 수 있습니다."],
    setup: "연습 설정", setupHeading: "다시 확인할 깊이 선택", targetDepth: "목표 깊이", language: "언어", questions: "질문 수",
    pass1: "1차 읽기 — 관련성", pass2: "2차 읽기 — 구조", pass3: "3차 읽기 — 깊은 이해", korean: "한국어", english: "영어",
    startLive: "실시간 회상 연습 시작", stopLive: "실시간 연습 중지", generateText: "텍스트 연습 만들기", microphoneReady: "실시간 음성을 사용할 수 있습니다. 연습을 시작할 때만 마이크 권한을 요청합니다.",
    ...
    microphoneDenied: "마이크 사용 권한이 허용되지 않았습니다.", startError: "회상 연습을 시작하지 못했습니다.", voiceLabel: "AI가 생성한 연습 음성",
    privacy: "연습 음성은 사람이 아닌 AI가 생성합니다. 이 페이지는 오디오와 대화 기록을 저장하지 않습니다.",
    textFallback: "텍스트 대안", answerMemory: "기억에서 답하기", developmentMock: "개발용 모의 연습", scoreText: "텍스트 답변 검토", scoreStopped: "중지한 실시간 연습 검토",
    transcript: "대화 기록", liveConversation: "실시간 대화", recordedLocal: "브라우저에 기록", turns: "{count}개 발화", examiner: "연습 안내자", you: "나", transcriptEmpty: "실시간 연습 중 대화가 이곳에 나타납니다.",
    result: "연습 결과", retrievalEvidence: "회상 결과: {score}/100", confidence: "확신도 {value}", mockWarning: "개발용 모의 결과이며 정확성을 평가하지 않았습니다.",
    copyScore: "결과 JSON 복사", copyTranscript: "대화 기록 복사", exportScore: "결과 JSON 내보내기", exportTranscript: "대화 기록 내보내기", copied: "{label} 복사 완료", copyFailed: "{label}을 복사하지 못했습니다. 아래에서 직접 선택하세요.", prepared: "{filename} 파일을 브라우저에서 준비했습니다.",
    keepLocal: "결과를 로컬에 보관하거나 다음 업데이트 전에 기록에 추가하세요.", reviewJson: "검토 결과 JSON",
    noApi: "API 없는 방식", manualTitle: "수동으로 회상 연습하기", manualBody: "프롬프트를 ChatGPT나 다른 모델에 붙여 넣으세요. 대화 기록은 로컬에 두고 반환된 결과 JSON만 기록에 추가합니다.",
    copyManual: "수동 회상 연습 프롬프트 복사", manualPrompt: "수동 회상 연습 프롬프트"
  },
  manualReview: {
    rereview: "노트 다시 검토", hide: "수동 프롬프트 닫기", title: "또는 노트 검토 프롬프트 복사",
    body: "ChatGPT나 다른 모델에 붙여 넣은 뒤 반환된 JSON 결과를 저장하세요.", copy: "노트 검토 프롬프트 복사", cli: "CLI 명령",
    prompt: "수동 노트 검토 프롬프트", copied: "프롬프트를 복사했습니다.", selected: "자동 복사가 차단되었습니다. 전체 프롬프트를 선택했으니 Ctrl+C 또는 Cmd+C를 누르세요.",
