...
export const enIslandMessages = {
  paper: {
    ...
    noLogs: "No paper notes yet.", noLogsBody: "The first note can be short: record why the paper matters and one question to revisit.",
    ...
    activityByDate: "Paper reading activity by date", papersOnDate: "{date}: {count} reading sessions", aiReview: "AI review", needsReview: "Needs another pass",
    ...
    statistics: "Paper reading statistics", sessionsToday: "Sessions today", papersTouchedToday: "Papers touched today", minutesToday: "Minutes today",
    ...
    publicNotes: "Paper notes: {count}. More activity views appear after three notes.", readingProcessEvidence: "Review summary",
    scoreScope: "Scores reflect what is written in each note and how the reading was recorded.", average: "Average", averageAi: "Average AI score",
  ...
  exam: {
    ...
    principlesLabel: "Live oral exam principles", principles: ["The score reflects what you can explain from memory.", "You can stop anytime and export your transcript.", "The examiner asks one question at a time.", "Use Korean or English."],
    setup: "Exam setup", setupHeading: "Choose how deeply to review", targetDepth: "Target depth", language: "Language", questions: "Questions",
    ...
    result: "Exam result", retrievalEvidence: "Recall score: {score}/100", confidence: "{value} confidence", mockWarning: "Development mock. This score did not evaluate correctness.",
...
export const koIslandMessages = {
  paper: {
    ...
    noLogs: "논문 기록이 아직 없습니다.", noLogsBody: "첫 기록은 짧아도 됩니다. 이 논문을 읽는 이유와 다시 볼 질문 하나를 남깁니다.",
    ...
    activityByDate: "날짜별 논문 읽기 활동", papersOnDate: "{date}: 읽기 세션 {count}회", aiReview: "AI 리뷰", needsReview: "다시 읽기 필요",
    ...
    publicNotes: "논문 기록 {count}개. 기록이 3개 이상 쌓이면 활동 보기가 열립니다.", readingProcessEvidence: "복습 요약",
    scoreScope: "점수는 각 기록에 적은 내용과 읽기 과정을 반영합니다.", average: "평균", averageAi: "AI 점수 평균",
  ...
  exam: {
    ...
    principlesLabel: "실시간 구술시험 원칙", principles: ["점수는 기억에서 설명할 수 있는 내용을 반영합니다.", "언제든 멈추고 대화 기록을 내보낼 수 있습니다.", "시험관은 한 번에 질문 하나를 합니다.", "한국어나 영어를 사용할 수 있습니다."],
    ...
    result: "시험 결과", retrievalEvidence: "회상 점수: {score}/100", confidence: "확신도 {value}", mockWarning: "개발용 모의 결과이며 정확성을 평가하지 않았습니다.",
