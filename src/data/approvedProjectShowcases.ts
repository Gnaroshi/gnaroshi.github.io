...
const sources = {
  ...
  arxiv: { applicationId: "arxiv-discovery", repository: "Gnaroshi/Arxiv-newest-paper-crawler", commit: "1f87f235e2bef334980c19e019c016bb2a60ef0c", width: 1946, height: 1480, disclosure: { en: "Titles, authors, dates, and summaries are deterministic demo metadata; network, translation, and download actions are disabled.", ko: "제목과 저자, 날짜, 요약은 모두 결정적으로 만든 데모 메타데이터이며 네트워크, 번역, 다운로드 동작은 비활성화되어 있습니다." } },
...
export const approvedProjectShowcases = [
  ...
  showcase(sources.arxiv, "discovery-list", "discover", "dark", { en: "Native Arxiv Discovery macOS window showing three deterministic demo paper candidates with network actions disabled.", ko: "결정적으로 만든 데모 논문 후보 세 개와 비활성화된 네트워크 동작을 보여 주는 네이티브 Arxiv Discovery macOS 창." }, { en: "Review a bounded native candidate list without network requests, translation, or downloads.", ko: "네트워크 요청, 번역, 다운로드 없이 범위를 제한한 네이티브 후보 목록을 검토합니다." }),
